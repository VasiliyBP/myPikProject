...
bulklistControllers.controller('newslist',['$scope', '$http',
    function($scope, $http){
        ...
        var getNewsLink = 'http://news.services.dev.vendelevas.dev3.pikweb.net/api/news?method=getNewsList&tags=pik.ru^realty&format=json&domain=localhost%3A63342';
